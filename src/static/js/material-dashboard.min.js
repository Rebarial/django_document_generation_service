...
function sidebarType(e) {
    ...
    "bg-transparent" != s && "bg-white" != s || !a ? (o = (l = document.querySelector(".navbar-brand-img")).src).includes("logo-ct-dark.png") && (c = o.replace("logo-ct-dark", "logo-ct"), l.src = c) : (o = (l = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && (c = o.replace("logo-ct", "logo-ct-dark"), l.src = c),
    "bg-white" == s && n && (o = (l = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && (c = o.replace("logo-ct", "logo-ct-dark"), l.src = c)
}
...
function navbarBlurOnScroll(e) {
    ...
    -1 < navigator.platform.indexOf("Win") && (s = document.querySelector(".main-content"), "true" == e ? s.addEventListener("ps-scroll-y", debounce(function() {
        (5 < s.scrollTop ? i : r)()
...
function darkMode(e) {
    ...
    if (e.getAttribute("checked")) {
        ...
        for (y = 0; y < r.length; y++)
            !r[y].classList.contains("text-white") || r[y].closest(".sidenav") || r[y].closest(".card.bg-gradient-dark") || (r[y].classList.remove("text-white"), r[y].classList.add("text-dark"));
        ...
        for (y = 0; y < v.length; y++)
            v[y].classList.contains("bg-gray-600") && (v[y].classList.remove("bg-gray-600"), v[y].classList.add("bg-gray-100"));
        ...
        for (var y = 0; y < l.length; y++)
            l[y].classList.contains("text-dark") && (l[y].classList.remove("text-dark"), l[y].classList.add("text-white"));
